        ...
        <div class="size-full flex border-l border-border-weaker-base">
          ...
          <Show when={shown()}>
            <FileTreePanel
              ...
              onFileClickAllTab={(path) => openTab(file.tab(path))}
              sizeActive={() => props.size.active()}
              onSizeStart={() => props.size.start()}
              onSizeTouch={() => props.size.touch()}
            />
          </Show>
        </div>
      </aside>
